...
export const StepId = {
  ...
  CreateAdminRoleAndAssignUser: "create-admin-role-and-assign-user" as StepIdValue,
...
export interface VariableMetadata {
  ...
  category: "auth" | "domain" | "config" | "state" | "serviceAccount" | "roles" | "microsoftApps" | "saml"
  description?: string
