...
const sampleSteps = [
  ...
  },
  {
    ...
    description: "Retrieves upcoming events from the user's primary Google Calendar for the next 7 days.",
  ...
  },
  {
    ...
    description: "Establishes a connection with Microsoft Graph API to enable contact synchronization.",
    requires: [] as const,
  ...
  },
  {
    ...
    description: "Syncs contacts between Google and Microsoft services based on the authenticated user's email.",
  ...
  },
  {
    ...
    description: "Compiles a report based on the fetched calendar events and contact synchronization status.",
