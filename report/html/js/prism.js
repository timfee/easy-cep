 ...
 */ (typeof module != "undefined" && module.exports && (module.exports = Prism),
  ...
  Object.defineProperty(Prism.languages.markup.tag, "addInlined", {
    value: function  value(e, t) {
      ...
      n["language-" + t] = { inside: Prism.languages[t], pattern: /[\s\S]+/ };
      const r = {};
      ((r[e] = {
        greedy: !0,
        inside: n,
  ...
  Prism.languages.insertBefore("javascript", "string", {
    hashbang: { alias: "comment", greedy: !0, pattern: /^#!.*/ },
    "template-string": {
      greedy: !0,
      inside: {
  ...
  (function () {
    if (void 0 !== Prism && typeof document != "undefined") {
      ...
      (Prism.hooks.add("before-highlightall", function (e) {
        ...
        Prism.hooks.add("before-sanity-check", function (s) {
          ...
          if (i.matches(r)) {
            ...
            (p.open("GET", u, !0),
              (p.onreadystatechange = function  onreadystatechange() {
                let e, a;
                p.readyState == 4 &&
        ...
        (Prism.plugins.fileHighlight = {
          highlight: function  highlight(e) {
            for (
              let t, a = (e || document).querySelectorAll(r), n = 0;
              (t = a[n++]);
            )
      ...
      let i = !1;
      Prism.fileHighlight = function  fileHighlight() {
        (i ||
          (console.warn(
    ...
    function l(e, t) {
      ...
      ((a = a.replace(s, " ") + " language-" + t),
        (e.className = a.replaceAll(/\s+/g, " ").trim()));
    }
  })());
